...
public class ShoppingCart {
    ...
    public void ShowMainShoppingMenu(Restaurant restaurant){
        ...
        int totalprice = calculator.CalculateTotalprice(Orderlist);
        Console.WriteLine("Total Price : {0} Baht",totalprice);
        Console.WriteLine("---------------------------------");
        ...
        while(laststagestatus != true){
            ...
            if(input == "1"){
                ...
                Input = input;
                ShowConfirmOrder(user,Orderlist,timeadd,totalprice);
            }
            else if(input == "2"){
                laststagestatus = true;
                Input = input;
    ...
    public void ShowConfirmOrder(User user,List<Order> Orderlist,PickUpTime timebook,int totalprice){
        Console.Clear();
        ...
        UserOrderHistory userorder = new UserOrderHistory(timebook,totalprice);
        foreach(Order order in Orderlist){
